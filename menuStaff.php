...
<body class="gradienHabibi">
    ...
    <div class="main-content">
                        ...
                        <div class="rev-content">
                            ...
                            <div class="search-results mt-3">
                                ...
                                if (!isset($_GET['query']) || empty($_GET['query'])) {
                                    $barangReference = $database->getReference('barang')->orderByKey()->limitToFirst($resultsPerPage)->getSnapshot();
                                } else {
                                    $query = $_GET['query'];
                                    $isNumeric = is_numeric($query);

                                    if ($isNumeric) {
                                        $barangReference = $database->getReference('barang')->orderByKey()->equalTo($query)->limitToFirst($resultsPerPage)->getSnapshot();
                                    } else {
                                        $barangReference = $database->getReference('barang')->orderByChild('nama_barang')->startAt($query)->endAt($query . "\uf8ff")->limitToFirst($resultsPerPage)->getSnapshot();
                                    }
                                }
        ...
        <div class='d-flex flex-column justify-content-center align-items-center'>
            ...
            <a href='prosesDelete.php?id=" . $key . "' class='btn btn-sm btn-danger mb-2'>Delete</a>
        </div>
      </td>";
                                ...
                                function confirmDelete(id) {
                                    ...
                                    Swal.fire({
                                        ...
                                        if (result.isConfirmed) {
                                            // Menggunakan ID yang telah dimodifikasi
                                            window.location.href = 'prosesDelete.php?id=' + safeId;
                                        }
                                    });
                                }
                            </script>
